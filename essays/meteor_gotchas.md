...
The applications that you could make from Meteor are simply not worth the amount of effort and time that you spend to get Meteor working properly and to use it. You can get much better bang for your buck elsewhere. I would not use Meteor for future development unless the Meteor developers at least fix the performance issues.
